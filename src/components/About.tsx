    ...
    <section id="about" className="relative w-full min-h-screen py-24 px-4 md:px-8 bg-ios-bg">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <TiltCard className="h-full">
              <div className="clay-card-dark p-8 flex flex-col justify-between h-full min-h-[320px]">
                ...
                <div className="relative mt-8 h-24 w-full rounded-xl overflow-hidden border border-white/5 bg-gradient-to-tr from-ios-blue/10 to-ios-purple/10 flex items-center justify-center">
                  {/* Stylized radar map overlay */}
                  <div className="absolute w-12 h-12 rounded-full border-2 border-ios-blue/40 animate-ping opacity-60" />
                  <div className="absolute w-4 h-4 rounded-full bg-ios-blue shadow-glow-blue border border-white" />
                  <span className="text-[10px] uppercase font-bold text-white/50 tracking-widest absolute bottom-2">Active Node</span>
                </div>
              </div>
            </TiltCard>
          </motion.div>
            ...
            <TiltCard className="h-full">
              <div className="clay-card-dark p-8 flex flex-col justify-between h-full min-h-[380px]">
                <div>
                  ...
                  <p className="text-xs font-bold text-ios-blue mb-4">
                    KL University
                  </p>
          ...
          {/* Card 4: Hardware & Software Stack combo (2 Columns Wide on desktop) */}
          <motion.div variants={itemVariants} className="md:col-span-2">
            <TiltCard className="h-full">
              <div className="clay-card-dark p-8 md:p-10 h-full min-h-[380px] flex flex-col justify-between">
                ...
                <div className="mt-8 pt-4 border-t border-white/5 flex items-center gap-3">
                  <Database className="w-4.5 h-4.5 text-ios-subtext" />
